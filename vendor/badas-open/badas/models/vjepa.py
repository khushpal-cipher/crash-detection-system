...
class VJEPAModel(BaseModel):
    ...
    def load(self) -> None:
        ...
        try:
            ...
            if self.use_sliding_window:
                ...
                print(
                    f"🎬 Sliding window predictor initialized (window={self.frame_count}, stride={self.window_stride})"
                )
    ...
    def set_tensor_save_callback(
        self, callback: Optional[Callable[[str, torch.Tensor], None]]
    ) -> None:
